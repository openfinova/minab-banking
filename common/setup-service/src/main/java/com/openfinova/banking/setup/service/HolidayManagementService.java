...
/**
 * Internal service for holiday calendar management and lookups.
 */
@Service
public class HolidayManagementService {

    private static final Logger logger = LoggerFactory.getLogger(HolidayManagementService.class);
    ...
    @PreAuthorize("hasAnyAuthority('holiday:read', 'admin:config:read', 'service:setup:read')")
    ...
    @Transactional
    @PreAuthorize("hasAnyAuthority('admin:config:write', 'service:setup:write')")
