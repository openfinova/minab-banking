...
public final class GlEntityFixtures {
    ...
    public static GLAccount usdAssetAccount() {
        return new GLAccount("1000", "Cash", GLAccountType.ASSET, "USD", "test");
    }

    public static GLAccount usdLiabilityAccount() {
        return new GLAccount("2000", "Deposits", GLAccountType.LIABILITY, "USD", "test");
    }

    public static GLTransaction draftTransaction(String referenceId) {
        return new GLTransaction(referenceId, "Test", LocalDate.of(2026, 5, 1), "test");
    }
}
